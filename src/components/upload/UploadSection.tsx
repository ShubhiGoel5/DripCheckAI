        ...
        >
          <div className="rounded-2xl glass-panel p-2 sm:p-3 relative overflow-hidden group">
            ...
            >
              ...
              {asset ? (
                <>
                  <img src={asset.preview} alt="Uploaded outfit preview" className="absolute inset-0 h-full w-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" />
