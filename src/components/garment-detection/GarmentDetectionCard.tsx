...
export const GarmentDetectionCard = ({ garments }: GarmentDetectionCardProps) => (
  <GlassCard className="p-6">
    <div className="mb-5">
      ...
      <h3 className="font-display text-3xl font-black text-[#171018]">Fashion Component Detection</h3>
    ...
    <div className="space-y-4">
      {garments.length === 0 && (
        <div className="rounded-2xl bg-white/58 p-4 shadow-[0_12px_32px_rgba(120,75,160,0.1)]">
          <p className="font-black text-[#171018]">No garments detected</p>
          <p className="mt-2 text-sm font-semibold leading-6 text-[#5F4967]">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="text-base font-black text-[#171018]">{garment.label}</p>
                  ...
                  <span className="rounded-full bg-white/80 px-2.5 py-1 text-xs font-black text-[#FF3CAC] shadow-sm">
                ...
                <div className="mt-4 flex flex-wrap gap-1.5">
                  {garment.dominantColor && (
                    <span className="flex items-center gap-1.5 rounded-lg bg-white/80 px-2.5 py-1 text-xs font-bold text-[#171018] shadow-sm">
                  ...
                  {garment.material && (
                    <span className="rounded-lg bg-white/80 px-2.5 py-1 text-xs font-bold text-[#4F3A56] shadow-sm">
