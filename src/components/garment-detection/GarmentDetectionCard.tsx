...
export const GarmentDetectionCard = ({ garments }: GarmentDetectionCardProps) => (
  <GlassCard className="p-6">
    <div className="mb-5">
      ...
      <h3 className="font-display text-3xl font-black text-white">Fashion Component Detection</h3>
    ...
    <div className="space-y-4">
      {garments.length === 0 && (
        <div className="rounded-2xl bg-white/58 p-4 shadow-[0_12px_32px_rgba(120,75,160,0.1)]">
          <p className="font-black text-white">No garments detected</p>
          <p className="mt-2 text-sm font-semibold leading-6 text-[#5F4967]">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="text-base font-black text-white">{garment.label}</p>
                ...
                <div className="mt-4 flex flex-wrap gap-1.5">
                  {garment.dominantColor && (
                    <span className="flex items-center gap-1.5 rounded-lg bg-white/10 px-2.5 py-1 text-xs font-bold text-white shadow-sm">
